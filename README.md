...
**Languages:**  
🧩 Python · LangChain · PyTorch · TensorFlow

**Frameworks & Tools:**  
🔥 Jetson Nano · Raspberry Pi · Arduino · 3D Printing  
...
- LLM deployment using Ollama & LangChain  
- Integrating vision and automation for agricultural research  
...
> ✨ “Build, learn, and share — that’s how innovation grows.”  

---

### ℹ️ Note on Emoji Usage
All emojis used here are **Unicode characters** supported natively on GitHub and most platforms.  
They are part of the open Unicode standard and **free for public use** — no licensing or attribution required.
